...
import group.chatting.application.AES;
...
public class UserOne implements ActionListener, Runnable {
    ...
    UserOne() {
        ...
        JLabel status = new JLabel("Vidhit, Vedant, Om, Sweety, IG Dubey, Shukla");
    ...
    public void actionPerformed(ActionEvent ae) {
        try {
            ...
            try {
                String encrypted = AES.encrypt(name + ": " + text.getText());
    ...
    public void run() {
        try {
            ...
            while(true) {
                ...
                if (decrypted.contains(name)) {
                    continue;
                }
                JPanel panel = formatLabel(decrypted);
